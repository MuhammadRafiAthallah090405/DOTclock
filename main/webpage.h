  ...
  <body>
        ...
        <div class="card">
          ...
          >
            <path
              ...
              stroke-width="3"
              d="m10.5 11-.5 1m2-8c-1.262 1.683-3.055 3.896-4.708 5.896-2.288 2.767-1.796 6.907 1.115 9.009a6.137 6.137 0 0 0 7.186 0c2.91-2.102 3.403-6.242 1.116-9.009C15.055 7.896 13.262 5.683 12 4Z"
            />
          </svg>
    ...
    <div id="timeModal" class="modal">
      <div class="modal-content">
        <button class="close-btn" onclick="closeModal('timeModal')">
          &times;
        </button>
    ...
    <div id="dateModal" class="modal">
      <div class="modal-content">
        <button class="close-btn" onclick="closeModal('dateModal')">
          &times;
        </button>
    ...
    <div id="alarmModal" class="modal">
      <div class="modal-content">
        <button class="close-btn" onclick="closeModal('alarmModal')">
          &times;
        </button>
